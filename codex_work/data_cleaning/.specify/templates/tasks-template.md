...
feature specification explicitly documents a waiver with rationale.
**Documentation**: README and usage updates are REQUIRED for every feature.
...
- [ ] TXXX Update `README.md` with current functionality and how to run it
